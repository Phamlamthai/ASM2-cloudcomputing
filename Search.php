...
<body>
	...
	<div class="A">
		<h3 style="text-align: center; font-size:45px; color: red; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;"><span>Car-Store</span></h3>
	</div>
	<div id=Mycarousel class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="item">
				<img src="Image/ferrari.jpg" style="width: 1920px;height:530px;"alt="OLS">
			</div>
			<div class="item">
				<img src="Image/car4.jpg" style="width: 1920px;height:530px;"alt="LSS">
			</div>
		</div>
	...
	<div class="container" style="margin-top: 20px;">
		<div class="row">
			...
			<div class="card" style="background-color: white;margin-top:20px;margin-left: 35px;overflow: auto; width: 270px; border: 2px solid #F8ABAB; border-radius: 1px;border-bottom: 6px solid #FCA5A5; float: left;">
					<a href="detail.php?id=<?php echo $row['product_id']?>" style="text-decoration: none;text-align: center;"> 

				<div><img src="Image/<?php echo $row['product_img']?>" style="width: 247px;height: 200px;padding: 7px;">
					<p style="color: red"><h3>Price:<?php echo $row['product_price']; ?></h3></p>
					</a>
					<button><b style="color:skyblue; background-color: gray;">Add To Cart</b></button>
				</div>
				<?php
					}
				}
